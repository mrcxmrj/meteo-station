class ChartContainer:
    def __init__(self, chart_template: str, selected_category: str = "") -> None:
        ...
        self.dropdown_items = {
            "temperature": '<li><a href="/charts/temperature">temperature</a></li>',
            "humidity": '<li><a href="/charts/humidity">humidity</a></li>',
            "pressure": '<li><a href="/charts/pressure">pressure</a></li>',
        }
